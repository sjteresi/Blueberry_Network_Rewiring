...
biblio-style: apsr
title: "Identify Blueberry to *Arabidopsis* Orthologs"
author:
- name: Scott J. Teresi
  affiliation: Edger Lab - Michigan State University
abstract: "This document contains my workflow, scripts and notes on generating *Vaccinium corymbosum* to *Arabidopsis thaliana* orthologs"
...
## SynMap Output:
It outputs a tab-separated text file. I would encourage the reader to check out the summary of the output format from this [link](https://genomevolution.org/wiki/index.php/SynMap) under *Results* and *DAGChainer Output*.

## Filter the Output File:
The DAGChainer output file has a lot of extraneous information. We are going to distill it down into a 2-column tab-separated values (tsv) file.
