...
at_bb_allbf:                ## execute orthology code with our data
	$(ROOT_DIR)/src/At_BB/generate_pairs.py $(DEV_SYNTELOGS) $(DEV_HOMOLOGS) $(DEV_DIFFEXDIR)/All_Hap/Bonferroni Bonferroni All

at_bb_allfdr:                ## execute orthology code with our data
	$(ROOT_DIR)/src/At_BB/generate_pairs.py $(DEV_SYNTELOGS) $(DEV_HOMOLOGS) $(DEV_DIFFEXDIR)/All_Hap/FDR FDR All

# Single Hap ATBB
at_bb_singlebf:                ## execute orthology code with our data
	$(ROOT_DIR)/src/At_BB/generate_pairs.py $(DEV_SYNTELOGS) $(DEV_HOMOLOGS) $(DEV_DIFFEXDIR)/Single_Hap/Bonferroni Bonferroni Single
at_bb_singlefdr:                ## execute orthology code with our data
	$(ROOT_DIR)/src/At_BB/generate_pairs.py $(DEV_SYNTELOGS) $(DEV_HOMOLOGS) $(DEV_DIFFEXDIR)/Single_Hap/FDR FDR Single
